    ...
    return (
        <div id="wd-lab1">
            ...
            <div id="wd-h-tag">
                ...
                larger and bolder than the plain text and their subsection headings. This document 
                uses headings to introduce topics such as HTML Documents, HTML Tags, Heading Tags, etc.
            ...
            <div id="wd-p-tag">
                ...
                <p id="wd-p-2"> 
                    This is the second paragraph. Even though we added a deliberate gap between the paragraph above and this paragraph, 
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    <li>Toast a piece of sourdough bread.</li>
                    <li>Spread pesto on the toast.</li>
                    <li>Place burrata on the toast.</li>
                    <li>Place proscuitto on top.</li>
                    <li>Enjoy!</li>
                </ol>
            ...
            <div id="wd-forms">
                ...
                <textarea id="wd-textarea" cols={30} rows={10} defaultValue="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
                ...
                <select id="wd-select-one-genre">
                    ...
                    <option selected defaultValue="SCIFI">
                ...
                Please 
                <a href="https://github.com/diabrar/kambaz-next-js" id="wd-github"> click here </a> 
